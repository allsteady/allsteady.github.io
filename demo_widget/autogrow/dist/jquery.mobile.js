...
* Git HEAD hash: abc97542dd55aef1c906d6cb3be07bc9c1720fce <> Date: Fri Jan 24 2014 00:27:45 UTC
...
(function( $, window, undefined ) {
	...
	$.extend( $.mobile, {
		...
		silentScroll: function( ypos, timer ) {
			if ( $.type( ypos ) !== "number" ) {
...
(function( $, undefined ) {
	...
	$.widget( "mobile.textinput", $.mobile.textinput, {
		...
		_handleReflow : function ( event ) {
			console.log(" autogrow : reflow event is catched..... ");
		},
		...
		_timeout: function( event ) {
			console.log(" [_timeout] start current event : " + event.type );
			this._prepareHeightUpdate( this.options.keyupTimeoutBuffer );
			console.log(" [_timeout] end current event : " + event.type + "\n");
		},
		...
		_updateHeight: function() {
			...
			console.log(" current scrollTop " +  temp );
			this.element.css({
				"height": 0,
				"min-height": 0,
				"max-height": 0
			...
			console.log("parent height : " + this.element.parent().height() ) ;
			this.element.css({
				"height": height,
				"min-height": "",
				"max-height": ""
